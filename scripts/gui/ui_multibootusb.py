...
#
# Created: Fri Apr 10 07:04:47 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.imager = QtGui.QWidget()
        self.imager.setObjectName(_fromUtf8("imager"))
        self.horizontalLayout_7 = QtGui.QHBoxLayout(self.imager)
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.gridLayout_9 = QtGui.QGridLayout()
        self.gridLayout_9.setObjectName(_fromUtf8("gridLayout_9"))
        self.groupBox_7 = QtGui.QGroupBox(self.imager)
        ...
        self.pushbtn_imager_refreshusb = QtGui.QPushButton(self.groupBox_9)
        self.pushbtn_imager_refreshusb.setObjectName(_fromUtf8("pushbtn_imager_refreshusb"))
        self.verticalLayout_8.addWidget(self.pushbtn_imager_refreshusb)
        self.imager_disk_label = QtGui.QLabel(self.groupBox_9)
        self.imager_disk_label.setObjectName(_fromUtf8("imager_disk_label"))
        self.verticalLayout_8.addWidget(self.imager_disk_label)
        self.imager_total_size = QtGui.QLabel(self.groupBox_9)
        self.imager_total_size.setObjectName(_fromUtf8("imager_total_size"))
        self.verticalLayout_8.addWidget(self.imager_total_size)
        self.imager_uuid = QtGui.QLabel(self.groupBox_9)
        self.imager_uuid.setObjectName(_fromUtf8("imager_uuid"))
        ...
        self.imager_bootable = QtGui.QLabel(self.groupBox_10)
        self.imager_bootable.setObjectName(_fromUtf8("imager_bootable"))
        self.verticalLayout_9.addWidget(self.imager_bootable)
        self.imager_iso_size = QtGui.QLabel(self.groupBox_10)
        self.imager_iso_size.setObjectName(_fromUtf8("imager_iso_size"))
        ...
        self.groupBox_8 = QtGui.QGroupBox(self.imager)
        self.groupBox_8.setObjectName(_fromUtf8("groupBox_8"))
        self.verticalLayout_7 = QtGui.QVBoxLayout(self.groupBox_8)
        self.verticalLayout_7.setObjectName(_fromUtf8("verticalLayout_7"))
        self.imager_label_status = QtGui.QLabel(self.groupBox_8)
        ...
        self.imager_label_status.setText(_fromUtf8(""))
        self.imager_label_status.setObjectName(_fromUtf8("imager_label_status"))
        self.verticalLayout_7.addWidget(self.imager_label_status)
        self.gridLayout_12 = QtGui.QGridLayout()
        self.gridLayout_12.setObjectName(_fromUtf8("gridLayout_12"))
        self.imager_write = QtGui.QPushButton(self.groupBox_8)
        self.imager_write.setObjectName(_fromUtf8("imager_write"))
        self.gridLayout_12.addWidget(self.imager_write, 2, 2, 1, 1)
        self.imager_close = QtGui.QPushButton(self.groupBox_8)
        self.imager_close.setObjectName(_fromUtf8("imager_close"))
        ...
        self.imager_progressbar = QtGui.QProgressBar(self.groupBox_8)
        self.imager_progressbar.setProperty("value", 0)
        self.imager_progressbar.setObjectName(_fromUtf8("imager_progressbar"))
        ...
        self.tabWidget.addTab(self.imager, _fromUtf8(""))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_7.setTitle(_translate("Dialog", "Imager", None))
        self.groupBox_9.setTitle(_translate("Dialog", "--------------  USB details  -------------------", None))
        self.pushbtn_imager_refreshusb.setText(_translate("Dialog", "Refresh USB", None))
        self.imager_disk_label.setText(_translate("Dialog", "Disk Label ::", None))
        self.imager_total_size.setText(_translate("Dialog", "Disk Size", None))
        self.imager_uuid.setText(_translate("Dialog", "Disk Label ::", None))
        self.groupBox_10.setTitle(_translate("Dialog", "------------------------------  ISO details  ----------------------------------", None))
        self.pushButton.setText(_translate("Dialog", "Browse ISO", None))
        self.imager_bootable.setText(_translate("Dialog", "Bootable ISO", None))
        self.imager_iso_size.setText(_translate("Dialog", "ISO Size", None))
        self.groupBox_8.setTitle(_translate("Dialog", "Imager Progress", None))
        self.imager_write.setText(_translate("Dialog", "Write/Create", None))
        self.imager_close.setText(_translate("Dialog", "Close", None))
        self.label_10.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-weight:600; color:#ff0000;\">WARNING</span> : Any bootable USB using<span style=\" font-weight:600;\"> ISO Imager will destroy all data </span>on the selected USB disk. </p><p>Use it at your own risk. Developers are not responsile for loss of any data.</p></body></html>", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.imager), _translate("Dialog", "ISO Imager", None))
